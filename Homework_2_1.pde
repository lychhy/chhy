...
// part 1
  ...
  circle(x-d*0.2, y-0.7*d, d*0.9); //right ear
  circle(x-1.7*d, y-0.7*d, d*0.9); //left ear
  fill(255);
...
// part 2
  ...
  circle(x-d, y, d*1.5);  //face
  fill(96);
  circle(x-1.3*d, y-d*0.10, 0.4*d); //left eye
  circle(x-0.6*d, y-d*0.10, 0.4*d); //right eye
  fill(0);
  ellipse(x-d, y+0.2*d, 0.3*d, 0.2*d); //nose
  stroke(0);
  circle(x-1.2*d, y-d*0.05, 0.1*d); //button left eye
  circle(x-0.7*d, y-d*0.05, 0.1*d); //button right eye
  noFill();
  arc(x-d, y+0.35*d, 0.3*d, 0.3*d, 0, PI); //mouse
}
